...
public class SimplexNoise
{
    ...
    * @return Noise value in the range[-1; 1], value of 0 on all integer coordinates.
    */
    public float fractal(int octaves, float x)
    {
        float output = 0.0f;
        float denom = 0.0f;
    ...
    * @return Noise value in the range[-1; 1], value of 0 on all integer coordinates.
    */
    public float fractal(int octaves, float x, float y)
    {
        float output = 0.0f;
        float denom = 0.0f;
        float frequency = mFrequency;
    ...
    * @return Noise value in the range[-1; 1], value of 0 on all integer coordinates.
    */
    public float fractal(int octaves, float x, float y, float z)
    {
        float output = 0.0f;
        float denom = 0.0f;
        float frequency = mFrequency;
     ...
     */
    static Int32 fastfloor(float fp)
    {
        Int32 i = (Int32)(fp);
        return (fp < i) ? (i - 1) : (i);
    }
